...
namespace NullableTest
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Nullable<int>a : Null");
            Console.WriteLine($"a : {a}");
            Console.WriteLine($"a.HasValue : {a.HasValue}");
            Console.WriteLine("a.Value : {0} ", a?.ToString());     // 할당된 값이 없으므로 예외   
            Console.WriteLine($"a.GetValueOrDefault() : {a.GetValueOrDefault()}\n");

            int? b; // elvis operator
            b = null;
            Console.WriteLine($"Nullable<int>a : Null");
            Console.WriteLine($"b : {b}");
            Console.WriteLine($"b.HasValue : {b.HasValue}");
            //Console.WriteLine("b.Value : {0} ", a.Value);     // 할당된 값이 없으므로 예외   
            ...
            NullValue = "3. Null 이아닌 값으로 세팅되었습니다.";
